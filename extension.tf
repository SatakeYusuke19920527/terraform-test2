resource "azurerm_virtual_machine_extension" "vm_extension_iis" {
  name                 = local.vm_extension_hostname
  virtual_machine_id   = azurerm_windows_virtual_machine.satake-vm.id
